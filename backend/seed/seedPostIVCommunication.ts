...
const tsvFilePath = join(
  process.cwd(),
  "seedData/postIVCommunicationDetails.tsv"
);
const jsonOutputPath = join(
  process.cwd(),
  "seedData/postIVCommunicationData.json"
);

// Columns in the TSV file
const columns = [
  "programName", // Maps to programId via NRMP Program Code
  "communicationReceived", // Fame string field
  "thankYouLetterPolicy", // Shame string field
  "rankImpact", // Array of Comment (can be a string in this context)
  "source",
  "comments",
];

...
const tsvFilePath = join(process.cwd(), "seedData/secondLookDetails.tsv");
const jsonOutputPath = join(process.cwd(), "seedData/secondLookData.json");

// Columns in the TSV file
const columns = [
  "programName", // Maps to programId via NRMP Program Code
  "setting", // Fame string field
  "bearingOnRank", // Shame string field
];

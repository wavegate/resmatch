...
const tsvFilePath = join(process.cwd(), "seedData/impressionsDetails.tsv");
const jsonOutputPath = join(process.cwd(), "seedData/impressionsData.json");

// Columns in the TSV file
const columns = [
  "programName", // Maps to programId via NRMP Program Code
  "positives", // Fame string field
  "negatives", // Shame string field
  "howInterviewDayAffectsRank", // Array of Comment (can be a string in this context)
  "gift",
  "timeGiftReceived",
  "comments",
];

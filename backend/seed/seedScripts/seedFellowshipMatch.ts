...
const tsvFilePath = join(process.cwd(), "seedData/fellowshipMatchDetails.tsv");
const jsonOutputPath = join(process.cwd(), "seedData/fellowshipMatchData.json");

// Columns in the TSV file
const columns = [
  "programName", // Maps to programId via NRMP Program Code
  2024, // Fame string field
  2023, // Shame string field
  2022, // Array of Comment (can be a string in this context)
  2021,
];

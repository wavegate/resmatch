...
import QuestionHeader from "@/headers/QuestionHeader/QuestionHeader";
import QuestionDetails from "@/details/QuestionDetails/QuestionDetails";
...
export default ({ className }: QuestionTableProps) => {
  ...
  return (
    <div className={`${className}`}>
      ...
      <Controls
        ...
        openFilters={open}
        shareUrl="/question/add"
        shareText="Share Question"
      />
      ...
      <div className={`mt-2`}>
        ...
        {data?.questions && data.questions.length === 0 && <NoRecords />}
      </div>
    </div>
  );
};

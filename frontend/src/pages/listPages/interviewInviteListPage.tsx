...
import InterviewInviteTable from "@/tables/InterviewInviteTable";
...
const InterviewInviteListPage: React.FC<ListPageProps> = ({
  modelName,
  className,
}) => {
...
export default InterviewInviteListPage;

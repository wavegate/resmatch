...
export default function AddLOInterestResponse() {
  useAuthGuard();
  ...
  const { data: loiResponseData, isLoading } = useQuery({
    queryKey: ["lointerestResponse", id],
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    await mutateAsync(values).then(() => {
      ...
      queryClient.invalidateQueries({ queryKey: ["lointerestResponse"] });
      navigate("/lointerest-response"); // Singular navigation path
    });
  }
